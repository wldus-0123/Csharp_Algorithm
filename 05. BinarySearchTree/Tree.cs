...
namespace _05._BinarySearchTree
{
    ...
    //
    // 뿌리(root)   : 부모노드가 없는 최상위 노드, 트리의 깊이 0에 하나만 존재 (기준)
    ...
    internal class Tree
    {
        ...
        // < 이진 트리 >
        // 부모노드가 자식도드를 최대 2개까지만 가질 수 있는 트리
        // n개의 자식을 가질 수 있는 트리를 연결구 조를 변경하여 이진트리로 변환 가능
        // -> 특별한 이유가 없으면 이진트리로 구현하는 것이 일반적
        public class BinaryNode<T>
        {
            public T item;
            public BinaryNode<T> parent;
            public BinaryNode<T> leftt;

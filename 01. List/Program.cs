    ...
    internal class Program
    {
        ...
        *******************************************************/
        ...
        {   // list의 기본적인 사용방법 : 다른 기능도 ㅈㄴ 많으니까 알아서 설명서 보셈
            ...
            // 1. list에 데이터 추가 : 변수명.Add  +) 선호도 : Add > Insert 왜? - 리스트의 구현원리를 알아야함 
            ...
            list.Remove("2번째 데이터");  // 삭제하면서 뒤에 있던 데이터들을 앞으로 당김 (빈 공간을 허용 X)
            ...
            for(int i=0; i<list.Count; i++)  //list는 길이 X, 갯수를 세는 느낌..? (배열은 길이임 그래서 Length 씀)
            {
